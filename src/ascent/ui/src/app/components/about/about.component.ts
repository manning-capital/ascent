  ...
  template: `
    <div class="p-6 max-w-3xl mx-auto">
      ...
      <p-card>
        ...
        <ul class="list-disc list-inside text-surface-500 space-y-2">
        ...
        <div class="grid grid-cols-2 gap-4 text-sm">
          <div>
            <p class="text-surface-400 mb-1">Backend</p>
            <p class="text-fg">Python, FastAPI, SQLAlchemy, PostgreSQL</p>
          </div>
          <div>
            <p class="text-surface-400 mb-1">Frontend</p>
            <p class="text-fg">Angular, Tailwind CSS, Chart.js</p>
          </div>
          <div>
            <p class="text-surface-400 mb-1">Data</p>
